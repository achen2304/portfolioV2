...
export const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Material UI', icon: <MuiIcon className="w-8 h-8" /> },
      { name: 'DaisyUI', icon: <SiDaisyui className="w-8 h-8" /> },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'SolidWorks', icon: <SolidworksIcon className="w-8 h-8" /> },
      {
        name: 'Microsoft Office',
        icon: <TiVendorMicrosoft className="w-8 h-8" />,
      },
